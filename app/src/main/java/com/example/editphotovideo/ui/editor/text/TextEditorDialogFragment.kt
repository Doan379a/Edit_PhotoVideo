package com.example.editphotovideo.ui.editor.text
...
import com.example.editphotovideo.ui.editor.DismissListenerTextEditor
...
import com.example.editphotovideo.widget.pxToSp
import com.example.editphotovideo.widget.spToPx
...
class TextEditorDialogFragment : DialogFragment() {
    ...
    private fun viewListener() = binding.apply {
        ...
        tvKeyboard.setOnClickListener { setActiveTab(Tab.KEYBOARD) }
        tvFont.setOnClickListener { setActiveTab(Tab.FONT) }
        tvColor.setOnClickListener { setActiveTab(Tab.COLOR) }
        tvGravity.setOnClickListener { setActiveTab(Tab.GRAVITY) }
        tvRight.setOnClickListener { setActiveGravityTab(TabGravity.RIGHT) }
        tvLeft.setOnClickListener { setActiveGravityTab(TabGravity.LEFT) }
        tvCenter.setOnClickListener { setActiveGravityTab(TabGravity.CENTER) }
    }
    ...
    private fun hideFontAndColorPickers() {
        ...
        binding.tvKeyboard.setTextColor(Color.parseColor("#519FFF"))
        binding.tvFont.setTextColor(Color.parseColor("#A4A4A4"))
        binding.tvColor.setTextColor(Color.parseColor("#A4A4A4"))
        binding.tvGravity.setTextColor(Color.parseColor("#A4A4A4"))
    }
    ...
    private fun setActiveTab(tab: Tab) = binding.apply {
        ...
        val colorTextUnSelect = Color.parseColor("#A4A4A4")
        tvKeyboard.setTextColor(if (tab == Tab.KEYBOARD) colorTextSelect else colorTextUnSelect)
        tvFont.setTextColor(if (tab == Tab.FONT) colorTextSelect else colorTextUnSelect)
        tvColor.setTextColor(if (tab == Tab.COLOR) colorTextSelect else colorTextUnSelect)
        tvGravity.setTextColor(if (tab == Tab.GRAVITY) colorTextSelect else colorTextUnSelect)
    ...
    private fun setActiveGravityTab(tab: TabGravity) = binding.apply {
        ...
        val colorTextUnSelect = Color.parseColor("#A4A4A4")
        tvLeft.setTextColor(if (tab == TabGravity.LEFT) colorTextSelect else colorTextUnSelect)
        tvCenter.setTextColor(if (tab == TabGravity.CENTER) colorTextSelect else colorTextUnSelect)
        tvRight.setTextColor(if (tab == TabGravity.RIGHT) colorTextSelect else colorTextUnSelect)
        when (tab) {
            TabGravity.LEFT -> {

package com.example.editphotovideo.ui.tools.extract_audio
...
import com.example.editphotovideo.databinding.ActivityResultAudioBinding
import com.example.editphotovideo.utils.ImageUtils.DEFAULT_FOLDER
import com.example.editphotovideo.utils.ShareUtils
import com.example.editphotovideo.utils.VideoUtils.buildDeleteIntentSender
import com.example.editphotovideo.utils.VideoUtils.getDisplayNameFromUri
...
class ResultAudioActivity : BaseActivity<ActivityResultAudioBinding>() {
    ...
    private fun initMediaPlayer() {
        ...
        mediaPlayer?.setOnCompletionListener {
            isPlaying = false
            binding.btnPlayPause.setImageResource(com.example.editphotovideo.R.drawable.ic_play)
    ...
    private fun playAudio() {
        mediaPlayer?.start()
        isPlaying = true
        binding.btnPlayPause.setImageResource(com.example.editphotovideo.R.drawable.ic_pause)
        updateSeekBar()
    }

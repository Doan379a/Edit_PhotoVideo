...
fun getTemplateTrending(): List<Template> {
    return (1..6).map { i ->
        Template(id = i, imagePath = "template/trending/template_$i.webp", imagePathBackgr = "anh_backgr/trending/template_$i.webp")
    }
}

fun getTemplateAutumn(): List<Template> {
    return (7..12).map { i ->
        Template(id = i, imagePath = "template/autumn/template_$i.webp", imagePathBackgr = "anh_backgr/autumn/template_$i.webp")
    }
...
fun getTemplateNoel(): List<Template> {
    return (13..18).map { i ->
        Template(id = i, imagePath = "template/noel/template_$i.webp", imagePathBackgr = "anh_backgr/noel/template_$i.webp")
    }
}

fun getTemplateHaloween(): List<Template> {
    return (19..24).map { i ->
        Template(id = i, imagePath = "template/haloween/template_$i.webp", imagePathBackgr = "anh_backgr/haloween/template_$i.webp")
    }
}

fun getTemplateNeon(): List<Template> {
    return (25..30).map { i ->
        Template(id = i, imagePath = "template/neon/template_$i.webp", imagePathBackgr = "anh_backgr/neon/template_$i.webp")
    }
}

fun getTemplateWedding(): List<Template> {
    return (31..36).map { i ->
        Template(id = i, imagePath = "template/wedding/template_$i.webp", imagePathBackgr = "anh_backgr/wedding/template_$i.webp")
    }
}

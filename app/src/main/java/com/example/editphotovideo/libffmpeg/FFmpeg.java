...
import com.example.editphotovideo.libffmpeg.CommandResult;
...
public class FFmpeg implements FFmpegInterface {
    ...
    public void execute(Map<String, String> environvenmentVars, String[] cmd, FFmpegExecuteResponseHandler ffmpegExecuteResponseHandler)  {

...
import com.example.editphotovideo.library.zoomimg.animation.ViewPosition;
import com.example.editphotovideo.library.zoomimg.animation.ViewPositionAnimator;
import com.example.editphotovideo.library.zoomimg.animation.ViewPositionAnimator.PositionUpdateListener;
...
/**
 * Extension of {@link com.example.editphotovideo.library.zoomimg.transition.ViewsCoordinator} that allows requesting {@link #enter(Object, boolean)} or
 ...
 */
public class ViewsTransitionAnimator<ID> extends com.example.editphotovideo.library.zoomimg.transition.ViewsCoordinator<ID> {

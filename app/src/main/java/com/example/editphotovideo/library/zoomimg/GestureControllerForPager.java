...
/**
 * Allows cross movement between view controlled by this {@link com.example.editphotovideo.library.zoomimg.GestureController} and it's parent
...
public class GestureControllerForPager extends GestureController {
    ...
    private float scrollBy(@NonNull MotionEvent event, float dx) {
        ...
        final com.example.editphotovideo.library.zoomimg.State state = getState();
    ...
    private float splitPagerScroll(float dx, com.example.editphotovideo.library.zoomimg.State state, RectF movBounds) {

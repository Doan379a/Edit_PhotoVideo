...
public abstract class AnimationEngine implements Runnable {
    ...
    private final com.example.editphotovideo.library.zoomimg.internal.Fps fps;

    public AnimationEngine(@NonNull View view) {
        this.view = view;
        this.fps = GestureDebug.isDebugFps() ? new com.example.editphotovideo.library.zoomimg.internal.Fps() : null;
    }

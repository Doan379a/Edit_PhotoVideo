package com.example.editphotovideo.library.zoomimg.animation;
...
import com.example.editphotovideo.library.zoomimg.GestureControllerForPager;
import com.example.editphotovideo.library.zoomimg.Settings;
import com.example.editphotovideo.library.zoomimg.State;
import com.example.editphotovideo.library.zoomimg.internal.AnimationEngine;
import com.example.editphotovideo.library.zoomimg.internal.GestureDebug;
import com.example.editphotovideo.library.zoomimg.utils.FloatScroller;
import com.example.editphotovideo.library.zoomimg.utils.GravityUtils;
import com.example.editphotovideo.library.zoomimg.utils.MathUtils;
import com.example.editphotovideo.library.zoomimg.views.GestureImageView;
import com.example.editphotovideo.library.zoomimg.views.interfaces.ClipBounds;
import com.example.editphotovideo.library.zoomimg.views.interfaces.ClipView;
 ...
 * {@link #enter(com.example.editphotovideo.library.zoomimg.animation.ViewPosition, boolean)} method. <br>
 ...
 * You can also manually update initial view position using {@link #update(com.example.editphotovideo.library.zoomimg.animation.ViewPosition)} method.
 */
public class ViewPositionAnimator {
    ...
    private com.example.editphotovideo.library.zoomimg.animation.ViewPosition fromPos;
    private com.example.editphotovideo.library.zoomimg.animation.ViewPosition toPos;
    ...
    private final com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder fromPosHolder = new com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder();
    private final com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder toPosHolder = new com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder();

    private final com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener fromPositionListener =
            new com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
                @Override
                public void onViewPositionChanged(@NonNull com.example.editphotovideo.library.zoomimg.animation.ViewPosition position) {
    ...
    public ViewPositionAnimator(@NonNull GestureView to) {
        ...
        toPosHolder.init(toView, new com.example.editphotovideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
            @Override
            public void onViewPositionChanged(@NonNull com.example.editphotovideo.library.zoomimg.animation.ViewPosition position) {
                if (GestureDebug.isDebugAnimator()) {
     ...
     * {@link #enter(com.example.editphotovideo.library.zoomimg.animation.ViewPosition, boolean)} methods instead.</b>
     *
     ...
     * should update to new view using {@link #update(com.example.editphotovideo.library.zoomimg.animation.ViewPosition)} method.
     *
     * @param fromPos 'From' view position
     * @param withAnimation Whether to animate entering or immediately jump to entered state
     */
    public void enter(@NonNull com.example.editphotovideo.library.zoomimg.animation.ViewPosition fromPos, boolean withAnimation) {
        if (GestureDebug.isDebugAnimator()) {
     ...
     */
    public void update(@NonNull com.example.editphotovideo.library.zoomimg.animation.ViewPosition from) {
        if (GestureDebug.isDebugAnimator()) {
    ...
    private void updateInternal(@NonNull com.example.editphotovideo.library.zoomimg.animation.ViewPosition from) {
        cleanBeforeUpdateInternal();
        fromPos = from;
        applyCurrentPosition();
    }
     ...
     * or {@link #enter(com.example.editphotovideo.library.zoomimg.animation.ViewPosition, boolean)} again in order to continue using animator.
     *
    ...
    private void updateFromState() {
        ...
        if (fromNonePos && settings != null && toPos != null) {
            fromPos = fromPos == null ? com.example.editphotovideo.library.zoomimg.animation.ViewPosition.newInstance() : fromPos;

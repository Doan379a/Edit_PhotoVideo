package com.example.editphotovideo.library.zoomimg.transition.tracker;
...
/**
 * Class implementing both {@link com.example.editphotovideo.library.zoomimg.transition.tracker.FromTracker} and {@link com.example.editphotovideo.library.zoomimg.transition.tracker.IntoTracker} assuming that positions will
 ...
 * <p>
 * If you need to handle more advanced cases you should manually implement {@link com.example.editphotovideo.library.zoomimg.transition.tracker.FromTracker} and
 * {@link com.example.editphotovideo.library.zoomimg.transition.tracker.IntoTracker}, and use items ids instead of their positions.
 */

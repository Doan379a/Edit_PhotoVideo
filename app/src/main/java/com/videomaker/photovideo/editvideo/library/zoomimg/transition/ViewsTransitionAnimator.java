package com.videomaker.photovideo.editvideo.library.zoomimg.transition;
...
import com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition;
import com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionAnimator;
import com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionAnimator.PositionUpdateListener;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.GestureDebug;
import com.videomaker.photovideo.editvideo.library.zoomimg.transition.tracker.FromTracker;
import com.videomaker.photovideo.editvideo.library.zoomimg.transition.tracker.IntoTracker;
...
/**
 * Extension of {@link com.videomaker.photovideo.editvideo.library.zoomimg.transition.ViewsCoordinator} that allows requesting {@link #enter(Object, boolean)} or
 ...
 */
public class ViewsTransitionAnimator<ID> extends com.videomaker.photovideo.editvideo.library.zoomimg.transition.ViewsCoordinator<ID> {
    ...
    @NonNull
     ViewPositionAnimator getAnimatorNonNull() {
        if (getToView() == null) {

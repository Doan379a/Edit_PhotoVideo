...
public class FromRecyclerViewListener<ID> extends com.videomaker.photovideo.editvideo.library.zoomimg.transition.internal.FromBaseListener<RecyclerView, ID> {

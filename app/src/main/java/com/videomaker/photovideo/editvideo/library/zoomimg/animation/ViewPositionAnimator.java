package com.videomaker.photovideo.editvideo.library.zoomimg.animation;
...
import com.videomaker.photovideo.editvideo.library.zoomimg.GestureController;
import com.videomaker.photovideo.editvideo.library.zoomimg.GestureControllerForPager;
import com.videomaker.photovideo.editvideo.library.zoomimg.Settings;
import com.videomaker.photovideo.editvideo.library.zoomimg.State;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.AnimationEngine;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.GestureDebug;
import com.videomaker.photovideo.editvideo.library.zoomimg.utils.FloatScroller;
import com.videomaker.photovideo.editvideo.library.zoomimg.utils.GravityUtils;
import com.videomaker.photovideo.editvideo.library.zoomimg.utils.MathUtils;
import com.videomaker.photovideo.editvideo.library.zoomimg.views.GestureImageView;
import com.videomaker.photovideo.editvideo.library.zoomimg.views.interfaces.ClipBounds;
import com.videomaker.photovideo.editvideo.library.zoomimg.views.interfaces.ClipView;
import com.videomaker.photovideo.editvideo.library.zoomimg.views.interfaces.GestureView;
 ...
 * {@link #enter(com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition, boolean)} method. <br>
 ...
 * You can also manually update initial view position using {@link #update(com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition)} method.
 */
public class ViewPositionAnimator {
    ...
    private com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition fromPos;
    private com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition toPos;
    ...
    private final com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder fromPosHolder = new com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder();
    private final com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder toPosHolder = new com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder();

    private final com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener fromPositionListener =
            new com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
                @Override
                public void onViewPositionChanged(@NonNull com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition position) {
    ...
    public ViewPositionAnimator(@NonNull GestureView to) {
        ...
        toPosHolder.init(toView, new com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPositionHolder.OnViewPositionChangeListener() {
            @Override
            public void onViewPositionChanged(@NonNull com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition position) {
                if (GestureDebug.isDebugAnimator()) {
     ...
     * {@link #enter(com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition, boolean)} methods instead.</b>
     *
     ...
     * should update to new view using {@link #update(com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition)} method.
     *
     * @param fromPos 'From' view position
     * @param withAnimation Whether to animate entering or immediately jump to entered state
     */
    public void enter(@NonNull com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition fromPos, boolean withAnimation) {
        if (GestureDebug.isDebugAnimator()) {
     ...
     */
    public void update(@NonNull com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition from) {
        if (GestureDebug.isDebugAnimator()) {
    ...
    private void updateInternal(@NonNull com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition from) {
        cleanBeforeUpdateInternal();
        fromPos = from;
        applyCurrentPosition();
    }
     ...
     * or {@link #enter(com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition, boolean)} again in order to continue using animator.
     *
    ...
    private void updateFromState() {
        ...
        if (fromNonePos && settings != null && toPos != null) {
            fromPos = fromPos == null ? com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition.newInstance() : fromPos;

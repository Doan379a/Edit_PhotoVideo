...
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.ExitController;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.MovementBounds;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.detectors.RotationGestureDetector;
import com.videomaker.photovideo.editvideo.library.zoomimg.internal.detectors.ScaleGestureDetectorFixed;
...
/**
 * Handles touch events to update view's position state ({@link com.videomaker.photovideo.editvideo.library.zoomimg.State}) based on current
 ...
 * stuff.
 * <p>
 * State can be animated with {@link #animateStateTo(com.videomaker.photovideo.editvideo.library.zoomimg.State)} method.<br>
...
public class GestureController implements View.OnTouchListener {
    ...
    private final com.videomaker.photovideo.editvideo.library.zoomimg.State stateStart = new com.videomaker.photovideo.editvideo.library.zoomimg.State();
    private final com.videomaker.photovideo.editvideo.library.zoomimg.State stateEnd = new com.videomaker.photovideo.editvideo.library.zoomimg.State();

    private final View targetView;
    private final Settings settings;
    private final com.videomaker.photovideo.editvideo.library.zoomimg.State state = new com.videomaker.photovideo.editvideo.library.zoomimg.State();
    private final com.videomaker.photovideo.editvideo.library.zoomimg.State prevState = new com.videomaker.photovideo.editvideo.library.zoomimg.State();
     ...
     */
    @NonNull
    public com.videomaker.photovideo.editvideo.library.zoomimg.State getState() {
        return state;
    }
     ...
     * @see #animateStateTo(com.videomaker.photovideo.editvideo.library.zoomimg.State)
     */
    ...
    public boolean animateStateTo(@Nullable com.videomaker.photovideo.editvideo.library.zoomimg.State endState) {
        return animateStateTo(endState, true);
    }

    private boolean animateStateTo(@Nullable com.videomaker.photovideo.editvideo.library.zoomimg.State endState, boolean keepInBounds) {
        if (endState == null) {
            return false;
        }
        ...
        com.videomaker.photovideo.editvideo.library.zoomimg.State endStateRestricted = null;
        if (keepInBounds) {
    ...
    protected boolean onTouchInternal(@NonNull View view, @NonNull MotionEvent event) {
        ...
        if (isRestrictZoomRequested || isRestrictRotationRequested) {
            ...
            if (!exitController.isExitDetected()) {
                com.videomaker.photovideo.editvideo.library.zoomimg.State restrictedState = stateController.restrictStateBoundsCopy(
    ...
    protected boolean shouldDisallowInterceptTouch(MotionEvent event) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                final boolean isPannable = com.videomaker.photovideo.editvideo.library.zoomimg.State.compare(tmpRectF.width(), 0f) > 0
                        || com.videomaker.photovideo.editvideo.library.zoomimg.State.compare(tmpRectF.height(), 0f) > 0;
    ...
    protected boolean onFlingScroll(int dx, int dy) {
        ...
        return !com.videomaker.photovideo.editvideo.library.zoomimg.State.equals(prevX, toX) || !com.videomaker.photovideo.editvideo.library.zoomimg.State.equals(prevY, toY);
    }
    ...
    public interface OnStateChangeListener {
        void onStateChanged(com.videomaker.photovideo.editvideo.library.zoomimg.State state);

        void onStateReset(com.videomaker.photovideo.editvideo.library.zoomimg.State oldState, State newState);
    }

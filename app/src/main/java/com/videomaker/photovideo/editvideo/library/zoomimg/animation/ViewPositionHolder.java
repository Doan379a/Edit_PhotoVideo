...
class ViewPositionHolder implements ViewTreeObserver.OnPreDrawListener {
    ...
    private final com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition pos = com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition.newInstance();
    ...
    private void update() {
        if (view != null && listener != null && !isPaused) {
            boolean changed = com.videomaker.photovideo.editvideo.library.zoomimg.animation.ViewPosition.apply(pos, view);
            if (changed) {

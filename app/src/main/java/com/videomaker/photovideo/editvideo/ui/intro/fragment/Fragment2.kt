package com.videomaker.photovideo.editvideo.ui.intro.fragment
...
import com.videomaker.photovideo.editvideo.databinding.LayoutItemIntroBinding
import com.videomaker.photovideo.editvideo.model.IntroModel
    ...
    private fun initView() {
        try {
            val data = IntroModel(
                ...
                R.string.content_intro_2,  type = 0
            )
            if (data.type == 0) {

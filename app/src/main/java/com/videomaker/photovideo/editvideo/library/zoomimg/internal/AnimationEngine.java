...
public abstract class AnimationEngine implements Runnable {
    ...
    private final com.videomaker.photovideo.editvideo.library.zoomimg.internal.Fps fps;

    public AnimationEngine(@NonNull View view) {
        this.view = view;
        this.fps = GestureDebug.isDebugFps() ? new com.videomaker.photovideo.editvideo.library.zoomimg.internal.Fps() : null;
    }

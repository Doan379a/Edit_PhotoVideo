...
/**
 * Allows cross movement between view controlled by this {@link com.videomaker.photovideo.editvideo.library.zoomimg.GestureController} and it's parent
...
public class GestureControllerForPager extends GestureController {
    ...
    private float scrollBy(@NonNull MotionEvent event, float dx) {
        ...
        final com.videomaker.photovideo.editvideo.library.zoomimg.State state = getState();
    ...
    private float splitPagerScroll(float dx, com.videomaker.photovideo.editvideo.library.zoomimg.State state, RectF movBounds) {
